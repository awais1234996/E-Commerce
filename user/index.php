                ...
                <li>
                    <div class="slide-contain slider-opt03__layout01">
                        ...
                        <div class="text-content">
                            <i class="first-line">Stylish</i>
                            <h3 class="second-line">Bikes For Stylish Riders</h3>
                            <p class="third-line">Make yours Dreams Possible... That Makes You Happy,We Happy</p>
                            <p class="buttons">
