            ...
            <div id="main-content" class="main-content col-lg-9 col-md-8 col-sm-12 col-xs-12">
                ...
                <div class="block-item recently-products-cat md-margin-bottom-39">
                    <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile" data-slick='{"rows":1,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":0,"slidesToShow":5, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 3}},{"breakpoint":992, "settings":{ "slidesToShow": 3, "slidesMargin":30}},{"breakpoint":768, "settings":{ "slidesToShow": 2, "slidesMargin":10}}]}'>
                        <?php
                        $psql =  $obj->select("product", "*", "status='online'", "INNER JOIN category  ON product.categoryid=category.categoryid  INNER JOIN subcategory  ON product.subcategoryid=subcategory.subcategoryid", null, null);
                        foreach($psql as $pdfet) {
                        ?>
                            <li class="product-item">
                                <div class="contain-product layout-02">
                                    <div class="product-thumb">
                                        <?php
                                        $p = unserialize($pdfet['picture']);
                                        foreach ($p as $val) {
                                        ?>
                                            <a href="./shopping-cart.php" class="link-to-product">
                                                <img style="height: 100px; width:100px" src="<?php echo "../admin/product_img/" . $val ?>" /> </a>
                                        <?php
                                        }
                                        ?>
                                    </div>
                                    <div class="info">
                                        <b class="categories"><?php echo $pdfet['categoryname']  ?></b>
                                        <h4 class="product-title"><a href="#" class="pr-name"><?php echo $pdfet['subcategoryname']  ?></a></h4>
                                        <div class="price">
                ...
                <div class="product-category grid-style">
                    ...
                    <div class="row">
                        <ul class="products-list">
                            ...
                            <?php
                            $ysql = $obj->select("product", "*", "status='online'", "INNER JOIN category  ON product.categoryid=category.categoryid  INNER JOIN subcategory  ON product.subcategoryid=subcategory.subcategoryid", null, null);
                            foreach($ysql as $yfet) {
                                ...
                                <li class="product-item col-lg-4 col-md-4 col-sm-4 col-xs-6">
                                    <div class="contain-product layout-default">
                                        <div class="product-thumb">
                                            ...
                                            <?php
                                            $p = unserialize($yfet['picture']);
                                            foreach ($p as $val) {
                                            ?>
                                                <a href="./shopping-cart.php" class="link-to-product">
                                                    <img style="height: 250px; width:200px" src="<?php echo "../admin/product_img/" . $val ?>" />
                                                </a>
                                            <?php
                                            }
                                            ?>
                                        ...
                                        <div class="info">
                                            <b class="categories"><?php echo $yfet['subcategoryname']  ?></b>
                                            <h4 class="product-title"><a href="#" class="pr-name"><?php echo $yfet['categoryname']  ?></a></h4>
                                            <p class="message text-center"><?php echo $yfet['productname']; ?></p>
                                            <div class="price">
                                                <ins><span class="price-amount"><span class="currencySymbol">£</span>85.00</span></ins>
                                                <del><span class="price-amount"><span class="currencySymbol">£</span>95.00</span></del>
                                            </div>
                                            ...
                                            <div class="slide-down-box">
                                                <p class="message"><?php echo $yfet['shortdescription']; ?></p>
                                                <form id="logdata">
                                                    <div class="buttons">

                                                        <input type="hidden" name="productname" id="pname" value="<?php echo $yfet['productname']; ?>">
                                                        <input type="hidden" name="productcode" id="pcode" value="<?php echo $yfet['productcode']; ?>">
                                                        <input type="hidden" name="productunitprice" id="pprice" value="<?php echo $yfet['productunitprice']; ?>">
                                                        <input type="hidden" name="picture" id="ppic" value="<?php echo $p[0]; ?>">

                                                        <a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>

                                                        <a href="#" id="addbtn" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>add to cart</a>
                ...
                <div class="sidebar-contain">
                    <div class="widget biolife-filter">
                        ...
                        <div class="wgt-content">
                            <ul class="cat-list">
                            <?php
                                $catsql = $obj->select("category", "*");
                                foreach ($catsql as $catfet) {
                                ?>
                                    <li class="cat-list-item"><a href="category.php?categoryid=<?php echo $catfet['categoryid'] ?>" class="cat-link"><?php echo $catfet['categoryname']  ?></a></li>
                                <?php
                                }
                                ?>
                    ...
                    <div class="widget biolife-filter">
                        ...
                        <div class="wgt-content">
                            <ul class="cat-list">
                              <?php
                                $scatsql = $obj->select("subcategory", "*");
                               foreach ($scatsql as $scatfet) {
                                ?>
                                    <li class="cat-list-item"><a href="subcategory.php?subcategoryid=<?php echo $scatfet['subcategoryid'] ?>" class="cat-link"><?php echo $scatfet['subcategoryname']  ?></a></li>
                                <?php
                                }
                                ?>
                            </ul>
