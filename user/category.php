            ...
            <div id="main-content" class="main-content col-lg-9 col-md-8 col-sm-12 col-xs-12">
                ...
                <div class="block-item recently-products-cat md-margin-bottom-39">
                    <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile"
                        ...
                        <?php
                        $csql = $obj->select("product", "*", "product.categoryid = $ccategoryid", "INNER JOIN category ON product.categoryid = category.categoryid INNER JOIN subcategory ON product.subcategoryid = subcategory.subcategoryid");
                            ...
                            foreach ($csql as $cfet) {
                                ...
                                <li class="product-item col-lg-4 col-md-4 col-sm-4 col-xs-6">
                                    <div class="contain-product layout-default">
                                        <div class="product-thumb">
                                            <a href="./category.php?categoryid=<?php echo $cfet['categoryid'] ?>"
                ...
                <div class="sidebar-contain">
                    ...
                    <div class="widget biolife-filter">
                        ...
                        <div class="wgt-content">
                            <ul class="cat-list">
                                <?php
                                $sql = $obj->select("subcategory", "*", "idcategory = $ccategoryid", null);
